...
- name: Azure Virtual Network API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/faces/master/_listings/azure-virtual-network/subscriptions-subscriptionid-providers-microsoft-network-networkinterfaces-get.md
x-common:
